                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="maindata" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <select name="parent_id" value="{{ $item->title }}" id="parent_id" type="text"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" value="{{ $item->description }}" id="description" class="form-control"
                                minheight="3" requred>{{ old('description', $item->description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
